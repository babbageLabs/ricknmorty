...
export function ResidentCard({ url }: { url: string }): JSX.Element {
    ...
    useEffect(() => {
        ...
        console.log("id 22222222222222222", id);
                ...
                <Link href={`/character/${resident.id}`}>
                    <div className="max-w-sm rounded overflow-hidden shadow p-2 m-1">
                        ...
                        <div className="px-6 py-4 w-auto">
                            <div className="font-bold text-xl z-10 mt-2 text-blue-500 hover:underline hover:text-green">
                                {resident?.name}
                            </div>
                        </div>
                        <div className="p-1">
